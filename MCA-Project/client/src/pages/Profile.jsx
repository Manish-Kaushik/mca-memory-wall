...
const Profile = () => {
  ...
  try {
    ...
    // 2️⃣ upload profile image separately
    if (profileImage) {
    ...
    <div className="min-h-screen bg-gray-900 text-white pt-24 px-4 pb-10">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-gray-800/50 backdrop-blur-md border border-gray-700 rounded-2xl p-8 mb-8 shadow-2xl"
        >
              ...
              {isEditing ? (
                ...
                >
                  ...
                  <div className="flex gap-3 justify-center md:justify-start pt-2">
                    ...
                    <button
                      type="submit"
                      className="bg-green-600 hover:bg-green-500 px-6 py-2 rounded-full font-bold transition flex items-center gap-2"
                    >
                      <Save size={18} />
                      Save
                    </button>
                    ...
                    <button
                      ...
                      className="bg-gray-600 hover:bg-gray-500 px-6 py-2 rounded-full font-bold transition flex items-center gap-2"
                    >
                      <X size={18} />
                      Cancel
                    </button>
                ...
                <>
                  ...
                  <div className="mt-6">
                    ...
                    <button
                      onClick={handleEditToggle}
                      className="bg-purple-600 hover:bg-purple-500 text-white px-6 py-2 rounded-full font-bold transition shadow-lg shadow-purple-500/30 flex items-center gap-2 mx-auto md:mx-0"
                    >
                      <Edit2 size={18} />
                      Edit Profile
                    </button>
